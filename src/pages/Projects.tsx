  ...
  const projectsData = [
    ...
    },
    {
    ...
    },
     {
      ...
      description: 'Developed a comprehensive medical management platform to manage patient records, appointments, prescriptions, and billing. Integrated with .NET Core Web API and SQL Server for secure and scalable data handling.',
      image: 'https://d3nwecxvwq3b5n.cloudfront.net/AcuCustom/Sitename/DAM/040/iStock-1477437266.jpg',
      liveUrl: 'https://example.com',
      codeUrl: 'https://github.com',
